========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта четвёртый проект (символы и строки)
========================================================================

Это приложение четвёртый проект (символы и строки) создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения четвёртый проект (символы и строки).


четвёртый проект (символы и строки).vcxproj
...
четвёртый проект (символы и строки).vcxproj.filters
...
четвёртый проект (символы и строки).cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем четвёртый проект (символы и строки).pch и файла предкомпилированных типов с именем StdAfx.obj.
